...
module.exports = {
    ...
    FOOTER: process.env.FOOTER === undefined ? '𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 ʜᴜꜱꜱᴇɪɴ ꜱᴀʟᴇʜ ²⁰²²' : process.env.FOOTER,
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 ʜᴜꜱꜱᴇɪɴ ꜱᴀʟᴇʜ ²⁰²²' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 ʜᴜꜱꜱᴇɪɴ ꜱᴀʟᴇʜ ²⁰²²' : process.env.CAPTION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://husseinsaleh.com/thimeets/2022/08/Picsart_22-08-04_17-25-03-121.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
    INBOX_BLOCK: process.env.INBOX_BLOCK === undefined ? 'false' : process.env.INBOX_BLOCK,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://husseinsaleh.com/thimeets/2022/08/Picsart_22-08-04_17-25-03-121.jpg' : process.env.ALIVE_LOGO,
